-- CuraFamilia baseline schema
-- Apply on MySQL 8.x.
-- Rollback notes:
--   1. Export any data you need to preserve.
--   2. Drop child tables first, then parent tables, in reverse dependency order.
--   3. Re-running this file is safe because it uses IF NOT EXISTS guards.
...
CREATE TABLE IF NOT EXISTS appointments (
  ...
  CONSTRAINT fk_appointments_senior FOREIGN KEY (senior_id) REFERENCES users (id) ON DELETE CASCADE
...
CREATE TABLE IF NOT EXISTS chatbot_sessions (
  ...
  CONSTRAINT fk_chatbot_sessions_senior FOREIGN KEY (senior_id) REFERENCES users (id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS chatbot_daily_summaries (
  ...
  CONSTRAINT fk_chatbot_daily_summaries_senior FOREIGN KEY (senior_id) REFERENCES users (id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS daily_checkins (
  ...
  CONSTRAINT fk_daily_checkins_senior FOREIGN KEY (senior_id) REFERENCES users (id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS family_senior_links (
  ...
  CONSTRAINT fk_family_senior_links_family_user FOREIGN KEY (family_user_id) REFERENCES users (id) ON DELETE CASCADE,
  CONSTRAINT fk_family_senior_links_senior_user FOREIGN KEY (senior_user_id) REFERENCES users (id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS medications (
  ...
  CONSTRAINT fk_medications_senior FOREIGN KEY (senior_id) REFERENCES users (id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS medication_takes (
  ...
  CONSTRAINT fk_medication_takes_medication FOREIGN KEY (medication_id) REFERENCES medications (id) ON DELETE CASCADE,
  CONSTRAINT fk_medication_takes_senior FOREIGN KEY (senior_id) REFERENCES users (id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS sos_alerts (
  ...
  CONSTRAINT fk_sos_alerts_senior FOREIGN KEY (senior_id) REFERENCES users (id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
